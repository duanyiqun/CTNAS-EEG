...
class SearchCNN(nn.Module):
    ...
    def __init__(self, C_in, C, S_c, n_classes, n_layers, n_nodes=4, stem_multiplier=3):
        """
        Args:
        ...
        self.channel_wise_mix = nn.Sequential(
            nn.Conv2d(C_in, C_cur, (1, 1), 1, (0, 0), bias=False),
            # nn.Conv2d(C_in, C_cur, 3, 1, 1, bias=False),
            nn.BatchNorm2d(C_cur)
        )
...
class SearchCNNController(nn.Module):
    ...
    def __init__(self, C_in, C, S_c, n_classes, n_layers, criterion, n_nodes=4, stem_multiplier=3):
        super().__init__()
