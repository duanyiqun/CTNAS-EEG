...
# from mudus.models.backbone.DARTS.Pawarelayer import Partial_aware_layer_improved, Partial_aware_layer_or
...
OPS = {
    ...
    'sep_conv_1x15': lambda C, stride, affine: SepConv(C, C, (1, 17), stride, (0, 8), affine=affine),
