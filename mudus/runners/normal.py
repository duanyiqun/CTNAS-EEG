...
from mudus.models.head.MAML_fc import MtlLearner
...
from mudus.dataset.dataloader.dataset_loader_BCI_IV_c import DatasetLoader_BCI_IV_mix as Dataset
...
class Noraml_Trainer(object):
    ...
    def __init__(self, args):
        ...
        self.lr_scheduler = lr_scheduler.CosineAnnealingLR(self.optimizer, args.epochs, eta_min=0.000001)
...
class Normal_Search_Trainer(object):
    ...
    def __init__(self, args):
       ...
       # Load pretrain set
        ...
        self.lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(self.w_optim, args.epochs, eta_min=0.00001)
...
class Searched_ReTrainer(object):
    ...
    def __init__(self, args):
       ...
       # Load pretrain set
        ...
        self.model.load_state_dict(torch.load(searched_path)['params'])
