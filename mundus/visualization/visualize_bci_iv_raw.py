...
from mundus.visualization.visualize_utils_mne import raw_construct_mne_info
...
if __name__ == '__main__':
    train_X, test_X, train_y, test_y = load_raw_data('/Users/organization/Documents/BCI/Mudus_BCI/data/bci_iv/')
